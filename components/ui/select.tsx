    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        [
          ...
          "rounded-lg border border-input bg-background px-3 text-sm text-foreground shadow-xs",
          "outline-none",
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          [
            ...
            "min-w-32 overflow-x-hidden overflow-y-auto",
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          ...
          "rounded-lg py-2 pr-8 pl-2.5 text-sm outline-none",
    ...
    >
      <span data-slot="select-item-indicator" className="absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <PiCheck className="size-4 text-primary" />
        </SelectPrimitive.ItemIndicator>
      </span>
