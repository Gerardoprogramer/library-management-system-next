      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          [
            ...
            "rounded-2xl border border-border/80 bg-card p-5 text-card-foreground shadow-2xl sm:max-w-lg sm:p-6",
            "outline-none",
            "data-[state=open]:animate-in data-[state=closed]:animate-out",
            "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="dialog-header" className={cn("flex flex-col gap-1.5 pr-10 text-left", className)} {...props} />
  );
}
